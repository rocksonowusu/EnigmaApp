...
SECRET_KEY = 'django-insecure-ksk)ph9klm!ls@0$ho85*ini)+o6h!en_kxt$a59t_*4*a9fr@'
...
DATABASES = {
    'default': dj_database_url.config(
        default="postgresql://enigma_db_owner:npg_M7Hru9vmxLVO@ep-young-darkness-a50pjn8g-pooler.us-east-2.aws.neon.tech/enigma_db?sslmode=require",
        conn_max_age=600,
    )
}
